...
The city averaged <h8>`r round(autothefts_city$last12mos/52,0)`</h8> stolen vehicles a week over the last 12 months. In 2022, that number was <h8>`r round(autothefts_city$total22/52,0)`</h8> a week.
...
<br>
<br>
<!-- <subhead>Auto thefts year by year, 2020 through last month</subhead> -->
