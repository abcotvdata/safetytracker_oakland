...
#6 https://cityofoakland2.app.box.com/s/sjiq7usfy27gy9dfe51hp8arz5l1ixad/folder/153744258933
...
# Load the file we want for 2021 (December / Year End)
# pdftext <- pdf_text("data/source/recent/230626_Area 6 Weekly Crime Report 19Jun23 - 25Jun23.pdf") %>% strsplit(split = "\n")

# Find files containing "Area 1 Weekly" in their name
files <- list.files(dir_path, pattern = "Area 6 Weekly", full.names = TRUE)
