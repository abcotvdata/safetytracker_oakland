...
pdftext <- pdf_text("data/source/recent/230206_Area 1 Weekly Crime Report 30Jan23 - 05Feb23.pdf") %>% strsplit(split = "\n")
...
# Load the file we want for 2021 (December / Year End)
pdftext <- pdf_text("data/source/recent/230206_Area 2 Weekly Crime Report 30Jan23 - 05Feb23.pdf") %>% strsplit(split = "\n")
...
# Load the file we want for 2021 (December / Year End)
pdftext <- pdf_text("data/source/recent/230206_Area 3 Weekly Crime Report 30Jan23 - 05Feb23.pdf") %>% strsplit(split = "\n")
...
# Load the file we want for 2021 (December / Year End)
pdftext <- pdf_text("data/source/recent/230206_Area 4 Weekly Crime Report 30Jan23 - 05Feb23.pdf") %>% strsplit(split = "\n")
...
# Load the file we want for 2021 (December / Year End)
pdftext <- pdf_text("data/source/recent/230206_Area 5 Weekly Crime Report 30Jan23 - 05Feb23.pdf") %>% strsplit(split = "\n")
...
# Load the file we want for 2021 (December / Year End)
pdftext <- pdf_text("data/source/recent/230206_Citywide Weekly Crime Report 30Jan23 - 05Feb23.pdf") %>% strsplit(split = "\n")
