...
pdftext <- pdf_text("data/source/recent/230123_Area 1 Weekly Crime Report 16Jan23 - 22Jan23.pdf") %>% strsplit(split = "\n")
...
# Load the file we want for 2021 (December / Year End)
pdftext <- pdf_text("data/source/recent/230123_Area 2 Weekly Crime Report 16Jan23 - 22Jan23.pdf") %>% strsplit(split = "\n")
...
# Load the file we want for 2021 (December / Year End)
pdftext <- pdf_text("data/source/recent/230123_Area 3 Weekly Crime Report 16Jan23 - 22Jan23.pdf") %>% strsplit(split = "\n")
...
# Load the file we want for 2021 (December / Year End)
pdftext <- pdf_text("data/source/recent/230123_Area 4 Weekly Crime Report 16Jan23 - 22Jan23.pdf") %>% strsplit(split = "\n")
...
# Load the file we want for 2021 (December / Year End)
pdftext <- pdf_text("data/source/recent/230123_Area 5 Weekly Crime Report 16Jan23 - 22Jan23.pdf") %>% strsplit(split = "\n")
...
# Load the file we want for 2021 (December / Year End)
pdftext <- pdf_text("data/source/recent/230123_Citywide Weekly Crime Report 16Jan23 - 22Jan23.pdf") %>% strsplit(split = "\n")
