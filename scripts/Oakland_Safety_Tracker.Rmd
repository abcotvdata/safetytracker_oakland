...
The city averaged <h8>`r round(murders_city$last12mos/52,1)`</h8> homicides a week over the last 12 months. In 2019, that number was <h8>`r round(murders_city$total19/52,1)`</h8> a week.
