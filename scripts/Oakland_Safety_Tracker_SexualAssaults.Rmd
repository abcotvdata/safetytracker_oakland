...
The danger is not the same neighborhood to neighborhood. ABC7's data team looked at the Oakland Police Department's public data about sexual assault reports by neighborhood from 2020 through `r format(asofdate, "%B %d, %Y")`.
