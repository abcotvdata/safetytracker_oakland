...
# GEOGRAPHY
# Get Oakland police beats; smaller analysis area not using for trackers
# preserving for archive purposes and potential upgrades/enhancements later
download.file("https://data.oaklandca.gov/api/geospatial/78s7-673i?method=export&format=GeoJSON",
              "data/source/geo/oakland_police_beats.geojson")

# Read in geojson and then transform to sf format
beats_geo <- st_read("data/source/geo/oakland_police_beats.geojson") %>% st_transform(3857)
