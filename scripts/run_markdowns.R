...
# Render page
rmarkdown::render('scripts/Oakland_Safety_Tracker.Rmd', 
                  output_dir = "docs",
                  output_file = 'Oakland_Safety_Tracker.html')
...
# Render page
rmarkdown::render('scripts/Oakland_Safety_Tracker_Burglaries.Rmd', 
                  output_dir = "docs",
                  output_file = "Oakland_Safety_Tracker_Burglaries.html")
...
# Render page
rmarkdown::render('scripts/Oakland_Safety_Tracker_Thefts.Rmd', 
                  output_dir = "docs",
                  output_file = 'Oakland_Safety_Tracker_Thefts.html')
...
# Render page
rmarkdown::render('scripts/Oakland_Safety_Tracker_VehicleThefts.Rmd', 
                  output_dir = "docs",
                  output_file = 'Oakland_Safety_Tracker_VehicleThefts.html')
...
# Render page
rmarkdown::render('scripts/Oakland_Safety_Tracker_Robberies.Rmd', 
                  output_dir = "docs",
                  output_file = 'Oakland_Safety_Tracker_Robberies.html')
...
# Render page
rmarkdown::render('scripts/Oakland_Safety_Tracker_Assaults.Rmd', 
                  output_dir = "docs",
                  output_file = 'Oakland_Safety_Tracker_Assaults.html')
...
# Render page
rmarkdown::render('scripts/Oakland_Safety_Tracker_SexualAssaults.Rmd', 
                  output_dir = "docs",
                  output_file = 'Oakland_Safety_Tracker_SexualAssaults.html')
